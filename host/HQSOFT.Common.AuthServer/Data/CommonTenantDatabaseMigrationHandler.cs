...
namespace HQSOFT.Common.Data;

public class CommonTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<CommonTenantDatabaseMigrationHandler> _logger;

    public CommonTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<CommonTenantDatabaseMigrationHandler> logger)
    {
